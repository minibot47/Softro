      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 min-h-[55vh]">
          {posts.map((post, i) => (
            <article
              key={i}
              className="rounded-2xl flex overflow-hidden group cursor-pointer hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-[#f8f8f8] dark:bg-[#151a16] dark:border dark:border-gray-800"
            >
              {/* Image wrapper */}
              ...
              <div className="w-1/2 p-6  flex flex-col items-start justify-center gap-3">
                ...
                <h3 className="text-black dark:text-white font-thin text-3xl leading-snug mb-4 group-hover:opacity-80 transition-opacity">
                  {post.title}
                </h3>
            
                <a href="#" className="hidden md:flex items-center gap-2 text-lg font-medium text-black dark:text-white mt-10">
                  Read more
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                    <path d="M7 17L17 7M17 7H7M17 7v10"/>
                  </svg>
